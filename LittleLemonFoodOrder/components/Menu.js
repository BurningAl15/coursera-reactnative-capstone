  ...
  <View style={styles.item}>
    <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
      <View style={{ flexDirection: "column" }}>
        ...
        <Text style={{ ...styles.title, color: "gray" }}>${item.price}</Text>
      </View>
    ...
    <View
      style={{ height: 2, backgroundColor: "#D3D3D3", marginTop: 15 }}
    ></View>
  </View>
);
  ...
  return (
    <View style={props.style.menuContainer}>
      ...
      {/* <View style={styles.sectionList}>
        ...
        {data && data[0].data.map((i, index) => <Item key={"c" + index} item={i} />)}
      </View> */}
    </View>
  );
}
